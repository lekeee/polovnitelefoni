    ...
    for ($i = 0; $i < count($ads); $i++) {
        ...
        <div data-w-id="e63ee92c-45eb-6251-f08f-7749d59a348c" class="widgetcontainer gold">
            <div class="mainwidgetcontainer">
                <div class="widgetimagescontainer" bg-image="<?php echo $putanja; ?>" style="display: flex; flex-direction: row; justify-content: space-between; backgroundImage='url(<?php echo $putanja; ?>)'">
                    <?php
                        $folderPath = "../uploads/" . $ads[$i]['images'];
                        $imagesCounter = 0;
                        if (is_dir($folderPath)) {
                    ...
                    <div class="addtocontainer">
                        <div class="addtosavedcontainer" style="padding: 5px"
                            
                            <?php
                                if($user->isLogged()){
                                    ?>
                                    onclick="checkIsSaved(event, this, <?php echo $user->getId() ?>, <?php echo $ads[$i]['ad_id'] ?>)"
                                    <?php
                                }else{
                                    ?>
                                    onclick="checkIsSaved2(event)"
                                    <?php
                                }
                            ?>
                            >
                ...
                <div class="widget-description-container">
                    ...
                    <div class="viewsadnsavescontainer">
                        ...
                        <div class="savescontainer">
                            ...
                            </div><img src="../public/src/love-icon.svg" loading="lazy" alt="Heart Icon" class="savesicon" />
                        </div>
                    </div>
