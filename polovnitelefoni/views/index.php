            ...
            <div class="showindpropertzcontainer">
                ...
                <div class="sortingcontainer">
                    <div class="sortingform w-form">
                        <form id="sorting-form" name="sorting-form" data-name="Sorting Form" method="get" class="sortingforma"
                            data-wf-page-id="65830899613e5c9e21ea6f3d"
                ...
                <div class="filterleftmaincontainer">
                    ...
                    <div class="filterleftcontainer">
                                ...
                                <form id="email-form-4" name="email-form-4" data-name="Email Form 4" method="get"
                                    ...
                                    <div class="statechecklboxcontainer"><label
                                            class="w-checkbox statedevicecheckbox"><input type="checkbox"
                                                id="oldState" name="oldState" data-name="old State"
                                            ...
                                            class="w-checkbox statedevicecheckbox"><input type="checkbox"
                                                id="newState" name="newState" data-name="new State"
                                                class="w-checkbox-input statecheckbox" /><span
                        ...
                        <div class="submitfilterscontainer">
                            ...
                            <a href="#" class="filterbutton removefilters w-button" id="resetFilters">Resetuj filtere</a>
                        </div>
                    </div>
                </div>
                <div class="productscontainer">
                    ...
                    <div class="productsmaincontainer">
                        <?php
                            ...
                            //     showWidget($ads, $i, $phone, $user);
                            // }
                        ?>
                    </div>
                    <div class="loadmorecontainer"><a href="#" class="loadmorebutton w-button">Učitaj još</a>
                    </div>
                </div>
            </div>
