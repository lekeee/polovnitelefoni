...
class User
{
        ...
        try {
            ...
            <div style='font-family: Arial, sans-serif; color:000; width: 600px; background-color: #fff; padding: 10px 0px 20px 0px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);'>
                ...
                <div style='padding-top: 0; padding-bottom: 10px; text-align: center; display: block;'>
                    <img src='https://polovni-telefoni.rs/public/src/polovnitelefoni.png' alt=''>
                </div>
                ...
                <div style='text-align: center; padding: 20px;'>
                    <img src='https://polovni-telefoni.rs/public/src/icons-instagram.svg' alt=''>
                    <img src='https://polovni-telefoni.rs/public/src/icons-facebook.svg' alt=''>
                </div>

                <footer style='background-color: rgb(33, 32, 32); padding: 20px; text-align: center;'>
                    <p style='color: white;'> © polovni-telefoni.rs, Inc. All rights reserved.</p>
                </footer>
    ...
    public function sendChangePasswordMail($email)
    {
        ...
        try {
            ...
            $imagePath = '../../public/src/polovnitelefoni.svg';
            $imageData = base64_encode(file_get_contents($imagePath));
            $imageMimeType = mime_content_type($imagePath);

            $mail->AddEmbeddedImage($imagePath, 'logo', 'polovnitelefoni.svg', 'base64', $imageMimeType);
            ...
            <div style='font-family: Arial, sans-serif; color:000; width: 600px; background-color: #fff; padding: 10px 0px 20px 0px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);'>
                ...
                <div style='padding-top: 0; padding-bottom: 10px; text-align: center; display: block;'>
                    <img src='cid:logo' alt='Polovni Telefoni Logo'>
                </div>
                <div style='display: flex; justify-content: center; align-items: center; background-color: #ED6969; height: 100px; margin: 0; padding: 0;'>
                    <img src='https://polovni-telefoni.rs/public/src/mail-icon.png' alt='Mail Ikonica' style='width: 50px; height: 50px;'>
                </div>
