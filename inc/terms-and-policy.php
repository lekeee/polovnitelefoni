...
<p>Welcome to Polovni Telefoni!</p>

<p>These terms and conditions outline the rules and regulations for the use of polovni-telefoni.rs's Website, located at
    www.polovni-telefoni.rs.</p>

<p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Polovni Telefoni if
...
<p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and all
    ...
    accordance with and subject to, prevailing law of rs. Any use of the above terminology or other words in the
    singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to
    same.</p>

<h3><strong>Cookies</strong></h3>

<p>We employ the use of cookies. By accessing Polovni Telefoni, you agreed to use cookies in agreement with the
    polovni-telefoni.rs's Privacy Policy. </p>
...
<p>Unless otherwise stated, polovni-telefoni.rs and/or its licensors own the intellectual property rights for all
    material on Polovni Telefoni. All intellectual property rights are reserved. You may access this from Polovni
    Telefoni for your own personal use subjected to restrictions set in these terms and conditions.</p>

<p>You must not:</p>
<ul>
    <li>Republish material from Polovni Telefoni</li>
    <li>Sell, rent or sub-license material from Polovni Telefoni</li>
    <li>Reproduce, duplicate or copy material from Polovni Telefoni</li>
    <li>Redistribute content from Polovni Telefoni</li>
</ul>
...
<p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas
    of the website. polovni-telefoni.rs does not filter, edit, publish or review Comments prior to their presence on the
    website. Comments do not reflect the views and opinions of polovni-telefoni.rs,its agents and/or affiliates.
    Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
    applicable laws, polovni-telefoni.rs shall not be liable for the Comments or for any liability, damages or expenses
    caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
    website.</p>

<p>polovni-telefoni.rs reserves the right to monitor all Comments and to remove any Comments which can be considered
...
<p>You hereby grant polovni-telefoni.rs a non-exclusive license to use, reproduce, edit and authorize others to use,
...
<p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
    ...
    with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of polovni-telefoni.rs;
...
<p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
    must inform us by sending an e-mail to polovni-telefoni.rs. Please include your name, your organization name,
...
<p>No use of polovni-telefoni.rs's logo or other artwork will be allowed for linking absent a trademark license
    agreement.</p>
