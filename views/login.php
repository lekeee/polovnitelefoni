...
<html data-wf-domain="polovni-telefoni.webflow.io" data-wf-page="655506e07faa7f82a5f25613"
    ...
    <head>
        <meta charset="utf-8" />
        <title>Polovni Telefoni | Prijava</title>
        ...
        <link href="../public/src/polovnitelefoni-only-logo.svg" rel="shortcut icon" type="image/x-icon" />
        <link href="" rel="../public/src/polovnitelefoni-only-logo.svg" />
    </head>
                        ...
                        <div class="div-block-24">
                            <div class="prijavacontainter">
                                <div class="form-block-2 w-form">
                                    <form id="wf-form-Email-Form-1" action="return false" name="wf-form-Email-Form-1" data-name="Email Form 1"
                                        method="post" class="form-2" data-wf-page-id="655506e07faa7f82a5f25613"
                                        data-wf-element-id="402ffa6f-510e-569c-4c22-28c4aa49bb28"><label for="login-email"
                                            class="field-label2">Korisničko ime ili email adresa *</label><input
                                            type="text" class="text-field-2 w-input" maxlength="256" name="login-email"
                                        ...
                                        <div class="div-block-22"><label for="email-2" class="field-label2">Lozinka
                                                *</label><img width="20" loading="lazy" alt="Show Password Icon"
                                                src="../public/src/show_password_icon.png"
                                                class="image-8" id="login-show-password" title="Prikaži lozinku"/><img width="20" loading="lazy" alt="Hide Password Icon"
                                                src="../public/src/hide_password_icon.png"
                                                class="image-7" id="login-hide-password" style="cursor: pointer;" title="Sakrij lozinku"/></div><input type="password"
                                            class="text-field-2 textfieldpassword w-input" maxlength="256"
                                            name="login-password" data-name="login-password" placeholder=""
                                        ...
                                        <div class="div-block-77" id="login-error-div" style="display: none">
                                            <div style="" id="login-error-div2"
                                                class="div-block-266">
                                                <div class="text-block-19" id='login-error'><b>GRESKA:</b> <span>Pogrešna email adresa ili lozinka</span></div>
                                            </div>
                                        </div>
                            ...
                            <div class="div-block-23 registracijacontainer">
                                <div class="form-block-2 w-form">
                                    <form id="email-form-2" action="return false" name="email-form-2" data-name="Email Form 2" method="get"
                                        class="form-2" data-wf-page-id="655506e07faa7f82a5f25613"
                                        ...
                                        <div class="div-block-22"><label for="email-4" class="field-label2">Lozinka
                                                *</label><img width="20" loading="lazy" alt="Show Password Icon"
                                                src="../public/src/show_password_icon.png"
                                                class="image-8" id="register-show-password"/><img width="20" loading="lazy" alt="Hide Password Icon"
                                                src="../public/src/hide_password_icon.png"
                                        ...
                                        <div class="div-block-22"><label for="email-4" class="field-label2">Potvrdite lozinku
                                                *</label><img width="20" loading="lazy" alt="Show Password Icon"
                                                src="../public/src/show_password_icon.png"
                                                class="image-8" id="register-show-repeated-password"/><img width="20" loading="lazy" alt="Hide Password Icon"
                                                src="../public/src/hide_password_icon.png"
                                                class="image-7" id="reqister-hide-repeated-password"/></div><input type="password"
                                            class="text-field-2 textfieldpassword w-input" maxlength="256"
                                ...
                                <div class="div-block-77" id="register-error-div" style="display: none">
                                    <div style="" id="register-error-div2"
                                        class="div-block-266">
                                        <div class="text-block-19" id='register-error'><b>GRESKA:</b> <span>Pogrešna email adresa ili lozinka</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
