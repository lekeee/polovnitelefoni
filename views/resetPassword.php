                ...
                <div class="form-block w-form">
                    <form id="resetPassword" name="email-form" action="return false" method="post"
                        ...
                        <div class="div-block-9">
                            ...
                            <img src="../public/src/show_password_icon.png" loading="lazy" alt="Prikazi lozinku"
                                class="image" style="cursor: pointer;" id="showNewPassword" />
                            <img src="../public/src/hide_password_icon.png" loading="lazy" alt="Sakrij lozinku"
                        ...
                        <div style="display: flex; justify-content: ceneter; align-items: center; width: 100%">
                            <a href="#" class="button w-button" id="updatePassword" uid-value="<?php echo $userID ?>"
                                style="max-width: 100%" data-value="Ažuriraj Lozinku"
                                data-wait="../public/src/loading.gif">Ažuriraj Lozinku</a>
                            <a href="#" class="button w-button" id="updatedPassword"
                                style="max-width: 100%;  display: none" uid-value="<?php echo $userID ?>">
                                <div style="display: flex; justify-content: center; align-items:center;">
                                    <img src="../public/src/done.png" alt="Lozinka uspesno promenjena"
                                        style="height: 20px">
